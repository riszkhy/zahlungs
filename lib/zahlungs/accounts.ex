defmodule Zahlungs.Accounts do
  @moduledoc """
  ...
  alias Zahlungs.Accounts.{User, UserToken, UserNotifier}
  ...
  @doc """
  Sets the role of a user. Intended for admin use only.

  ## Examples

      iex> set_user_role(user, "admin")
      {:ok, %User{}}

      iex> set_user_role(user, "bogus")
